    ...
    return (
        <>
            <div className="card justify-center w-full mt-5">
                <h1 className="text-3xl text-pink-700 underline font-Ubuntu mt-10 ml-16">React Templates</h1>
                <div className="wrap flex flex-wrap justify-center md:m-10 m-1">
                    <div className="card_hero shadow-2xl w-[400px] rounded-2xl m-10 cursor-pointer">
                        ...
                        <p className="m-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, libero.</p>
